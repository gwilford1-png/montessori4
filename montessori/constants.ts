...
const RAW_DATA: any[] = [
  ...
  { id: 1, title: "Munari Mobile", cat: "Visual", age: "0-3 Months", act: "Observe high-contrast shapes.", desc: "Mathematically-balanced black and white geometric shapes.", ben: "Builds early visual concentration.", item: "Munari Mobile", ref: "https://amshq.org/", prompt: "Black and white shapes." },
  { id: 2, title: "Melodic Anchoring", cat: "Auditory", age: "0-3 Months", act: "Listen to a soothing anchor.", desc: "A consistent, gentle melody used for acoustic comfort.", ben: "Builds auditory tracking.", item: "Wooden music box", ref: "https://amshq.org/", prompt: "Music box." },
