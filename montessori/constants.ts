...
const RAW_DATA: any[] = [
  ...
  { id: 2, title: "Melodic Anchoring", cat: "Auditory", age: "0-3 Months", act: "Listen to a soothing anchor.", desc: "A consistent, gentle melody used for acoustic comfort.", ben: "Builds auditory tracking.", item: "Wooden music box", ref: "https://amshq.org/", prompt: "Music box.", thumbnail: "images/melodic_anchoring.png" },
