...
const RAW_DATA: any[] = [
  ...
  { id: 4, title: "Black & White Cards", cat: "Visual", age: "0-3 Months", act: "High-contrast silhouettes.", desc: "Simple nature silhouettes for newborn focus.", ben: "Stimulates visual discrimination.", item: "Contrast cards", ref: "https://montessoriguide.org/", prompt: "B&W Cards.", thumbnail: "images/Black_White_Cards.png", hero: "images/Black_White_Cards_lrg.png", },
  { id: 5, title: "Gobbi Mobile", cat: "Visual", age: "0-3 Months", act: "Subtle shade discrimination.", desc: "Five spheres wrapped in silk thread of graduating shades.", ben: "Refines color discrimination.", item: "Gobbi Mobile", ref: "https://mariamontessori.com/", prompt: "Silk spheres.", thumbnail: "images/Gobbi_Mobile.png", },
  { id: 6, title: "The Dancers Mobile", cat: "Visual", age: "0-3 Months", act: "Observe shimmering movement.", desc: "Stylized figures made of iridescent paper.", ben: "Engages moving object focus.", item: "Dancers Mobile", ref: "https://amshq.org/", prompt: "Dancer figures.", thumbnail: "images/Dancers_Mobile.png", },
  { id: 7, title: "Floor Mirror Discovery", cat: "Social", age: "0-3 Months", act: "Self-observation.", desc: "Safe mirror at eye level for movement study.", ben: "Builds self-awareness.", item: "Acrylic floor mirror", ref: "https://amshq.org/", prompt: "Low mirror.", thumbnail: "images/Floor_Mirror_Discovery.png", },
  { id: 8, title: "Bell Rattle", cat: "Auditory", age: "3-6 Months", act: "Bell sound tracking.", desc: "Silver bell on a wooden handle.", ben: "Coordinates neck and sound.", item: "Silver bell rattle", ref: "https://amshq.org/", prompt: "Bell rattle.", thumbnail: "images/Bell_Rattle.png", },
  ...
  // 3-6 MONTHS
  { id: 26, title: "Interlocking Discs", cat: "Tactile", age: "3-6 Months", act: "Two-hand transfer.", desc: "Two wooden rings joined together.", ben: "Hand-to-hand transfer.", item: "Interlocking Discs", ref: "https://amshq.org/", prompt: "Joined Discs.", thumbnail: "images/Interlocking_Discs.png", },
  ...
  { id: 28, title: "Textured Sensory Balls", cat: "Sensory", age: "3-6 Months", act: "Surface exploration.", desc: "Nubby, smooth, and ridged balls.", ben: "Refines tactile sense.", item: "Textured balls", ref: "https://amshq.org/", prompt: "Bumpy balls.", thumbnail: "images/Textured_Sensory_Balls.png", },
